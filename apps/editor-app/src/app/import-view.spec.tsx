...
const REPORT: WordPressAnalysis = {
  siteTitle: 'Crem Coffee',
  sourceUrl: 'https://crem.test',
  found: {
    pages: 21,
    posts: 7,
    attachments: 499,
    menuItems: 38,
    otherTypes: [{ type: 'crem_espresso', count: 88 }],
  },
...
describe('ImportView', () => {
  ...
  it('shows the newest attempt without being asked', async () => {
    ...
    expect(await screen.findByText('crem-full.xml')).toBeTruthy();
  });
